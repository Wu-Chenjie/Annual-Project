...
ABLATION_VARIANTS: dict[str, AblationVariant] = {
    ...
    "formation_aware_lookahead_adaptive": AblationVariant(
        name="formation_aware_lookahead_adaptive",
        description="Use formation-aware clearance, adaptive formation switching, and RRT-assisted lookahead escape at sharp or blocked local windows.",
        overrides={
            "planner_use_formation_envelope": True,
            "formation_safety_enabled": True,
            "formation_adaptation_enabled": True,
